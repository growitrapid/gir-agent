export default {
  instructions: `You are a function that generates JSON from Markdown in the bellow format.
  [FORMAT]: {
    "title": string,
    "description": string,
    "thumbnail": string,
  ...
  md: `![Google](https://d3njjcbhbojbot.cloudfront.net/api/utilities/v1/imageproxy/http://coursera-university-assets.s3.amazonaws.com/4a/cb36835ae3421187080898a7ecc11d/Google-G_360x360.png?auto=format%2Ccompress&dpr=1&w=28&h=28)
  ...
  **Platforms and tools you will learn include:** Presentations, Spreadsheets,
  ...
  Course 1•18 hours•4.8 (98,840 ratings)
  ...
  Go to previous testimonialGo to next testimonial
  ...
  When Google saw the positive impact this program was having on people all over
  ...
  json: `{
    ...
    "description": "Get on the fast track to a career in Data Analytics. In this certificate program, you'll learn in-demand skills at your own pace, no degree or experience required.",
    "thumbnail": "https://d3njjcbhbojbot.cloudfront.net/api/utilities/v1/imageproxy/http://coursera-university-assets.s3.amazonaws.com/4a/cb36835ae3421187080898a7ecc11d/Google-G_360x360.png?auto=format%2Ccompress&dpr=1&w=28&h=28",
    "instructors": [
      "Google Career Certificates"
    ],
    "total_enrolled_students": "2052144",
    "rating": "4.8",
    ...
    "outcomes": "Receive professional-level training from Google Demonstrate your proficiency in portfolio-ready projects Earn an employer-recognized certificate from Google Qualify for in-demand job titles: Data Analyst, Junior Data Analyst, Associate Data Analyst",
    "series": [
      {
